...
struct  X509Store_t973  : public Object_t
{
	...
	X509Certificate2Collection_t967 * ___list_2;
	...
	X509Store_t776 * ___store_4;
};
struct X509Store_t973_StaticFields{
	...
	Dictionary_2_t263 * ___U3CU3Ef__switchU24mapF_5;
};
