...
struct  ExtendedKeyUsageExtension_t781  : public X509Extension_t775
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t740 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t781_StaticFields{
	...
	Dictionary_2_t263 * ___U3CU3Ef__switchU24map14_4;
};
