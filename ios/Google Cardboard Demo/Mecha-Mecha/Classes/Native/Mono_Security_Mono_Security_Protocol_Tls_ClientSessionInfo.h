...
struct  ClientSessionInfo_t803  : public Object_t
{
	...
	ByteU5BU5D_t87* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t87* ___masterSecret_5;
};
struct ClientSessionInfo_t803_StaticFields{
