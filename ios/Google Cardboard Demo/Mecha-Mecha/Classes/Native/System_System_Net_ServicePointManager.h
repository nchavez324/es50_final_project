...
struct  ServicePointManager_t889  : public Object_t
{
};
struct ServicePointManager_t889_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t917 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t901 * ___server_cert_cb_9;
};
